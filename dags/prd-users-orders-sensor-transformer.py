...
BUCKET_SOURCE = "owshq-uber-eats-files2"
...
def init():
    ...
    def transform_user(file_path: str) -> List[Dict]:
        ...
        with tempfile.NamedTemporaryFile() as temp_file:
            gcs_hook.download(bucket_name="owshq-uber-eats-files2", object_name=file_path, filename=temp_file.name)
    ...
    def transform_users():
        user_files = list_files(bucket="owshq-uber-eats-files2", prefix="com.owshq.data/mongodb/users/")
    ...
    def transform_orders():
        order_files = list_files(bucket="owshq-uber-eats-files2", prefix="com.owshq.data/kafka/orders/")
